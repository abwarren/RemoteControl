#!/usr/bin/env python3
"""
PLO5 6-max Equity Calculator
Calculates equity for PLO5 hands
"""
...
def main():
    ...
    for hand in hands:
        if len(hand) != 10:  # 5 cards * 2 chars each
            print(f"Error: PLO5 hands must be 10 characters (5 cards). Got: {hand}")
            sys.exit(1)

    print("=" * 60)
    print("PLO5 6-MAX EQUITY CALCULATOR")
    print("=" * 60)
