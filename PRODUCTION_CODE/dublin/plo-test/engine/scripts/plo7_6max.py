#!/usr/bin/env python3
"""
PLO7 6-max Equity Calculator
Calculates equity for PLO7 hands
"""
...
def main():
    ...
    for hand in hands:
        if len(hand) != 14:  # 5 cards * 2 chars each
            print(f"Error: PLO7 hands must be 14 characters (7 cards). Got: {hand}")
            sys.exit(1)

    print("=" * 60)
    print("PLO7 6-MAX EQUITY CALCULATOR")
    print("=" * 60)
