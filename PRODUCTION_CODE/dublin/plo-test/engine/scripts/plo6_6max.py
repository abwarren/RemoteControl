#!/usr/bin/env python3
"""
PLO6 6-max Equity Calculator
Calculates equity for PLO6 hands
"""
...
def main():
    ...
    for hand in hands:
        if len(hand) != 12:  # 5 cards * 2 chars each
            print(f"Error: PLO6 hands must be 12 characters (6 cards). Got: {hand}")
            sys.exit(1)

    print("=" * 60)
    print("PLO6 6-MAX EQUITY CALCULATOR")
    print("=" * 60)
