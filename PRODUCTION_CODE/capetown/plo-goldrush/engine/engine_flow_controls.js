...
function createControlPanel() {
  ...
  function updatePanelVisibility() {
    ...
    for (var i = 0; i < allBtns.length; i++) {
      ...
      if (hasActive || ariaSelected === "true" || hasBorder) { engineActive = true; break; }
    }
    if (!engineActive) {
      var ta = document.querySelector('textarea[rows="14"]');
      if (ta && ta.offsetParent !== null) engineActive = true;
    }
    panel.style.display = engineActive ? "block" : "none";
  }
